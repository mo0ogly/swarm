...
# Parcours opérateur : l'ordonnanceur est hors sujet ici, sinon il lancerait la
# tâche suivante pendant les manipulations (niveau par défaut d'un travail : autonome).
