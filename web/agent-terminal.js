'use strict';
const tr_web_agent_terminal_js = source => globalThis.SwarmI18n?.t(source) ?? source;
...
const AgentTerminal={
 open(a){
  ...
  const frame=node('iframe');frame.title=tr_web_agent_terminal_js('Session interactive de ')+a.provider;
